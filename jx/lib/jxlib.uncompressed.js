...
Jx.Button.Multi = new Class({
    ...
    initialize: function(opts) {
        ...
        // we use a button and steal a reference to its domObj so
        // we look like a button to the result of the world
        this.button = new Jx.Button();
        this.domObj = this.button.domObj;
        this.button.domA.addClass('jxButtonMulti');
        ...
        this.menu.addEvents({
            'show': (function() {
                $(this.domObj.firstChild).addClass('jxButtonActive');
            }).bind(this),
            'hide': (function() {
                $(this.domObj.firstChild).removeClass('jxButtonActive');
            }).bind(this)
        });
        a.adopt(new Element('img', {src: Jx.aPixel.src}));
        this.button.domObj.adopt(a);
        this.discloser = a;
    ...
    add: function() {
        $A(arguments).flatten().each(function(theButton){
            ...
            if (!this.activeButton) {
                this.button.domA.dispose();
                this.domObj.grab(theButton.domA, 'top');
    ...
    add : function() {
        $A(arguments).each(function(button) {
            ...
            button.setActive = function(isActive) {
                if (this.options.isActive && that.activeButton == this) {
                    return;
                } else {
                    Jx.Button.prototype.setActive.apply(this, [isActive]);
                }
            };
            if (!this.activeButton) {
                button.setActive(true);
            } else if (button.options.isActive) {
                button.options.isActive = false;
                button.setActive(true);
            }
...
// $Id: grid.js 812 2008-09-03 18:59:52Z pspencer $
/**
 * Class: Jx.Grid
...
// $Id: menu.item.js 822 2008-09-04 16:37:53Z pspencer $
/**
 * Class: Jx.Menu.Item
...
});// $Id: combo.js 888 2008-09-10 21:23:19Z pspencer $
/**
 * Class: Jx.Combo
...
Jx.Combo = new Class({
    ...
    initialize: function(options) {
        this.parent();
        this.button.domA.removeClass('jxButtonMulti');
        this.button.domA.addClass('jxButtonComboDefault');
        
        this.setOptions(options);
        if (this.options.editable) {
            this.button.domA.addClass('jxButtonEditCombo');
            this.domInput = new Element('input',{
                ...
                events:{
                    ...
                    focus: (function() {
                        if (this.button.domA.hasClass('jxButtonComboDefault')) {
                            this.domInput.value = '';
                            this.button.domA.removeClass('jxButtonComboDefault');
                        }
                    }).bind(this)
                },
                value: this.options.label
            });
            this.button.domLabel.addClass('jxComboInput');
            this.button.domLabel.adopt(this.domInput);
        } else {
            this.discloser.dispose();
            this.button.domA.addClass('jxButtonCombo');
            this.button.domLabel.addClass('jxButtonLabel');
            this.button.setLabel(this.options.label);
        ...
        this.buttonSet = new Jx.ButtonSet({
            onChange: (function(set) {
                ...
                if (this.options.editable) {
                    ...
                    this.button.setLabel(button.options.label);
                }
                this.button.setImage(button.options.image);
    ...
    getValue: function() {
        ...
        if (this.options.editable) {
            ...
            value = this.button.domLabel.innerHTML;
        }
        return value;
    }
...
// $Id: tabbox.js 853 2008-09-08 17:59:52Z pspencer $
/**
 * Class: Jx.TabBox
...
Jx.TabBox = new Class({
    ...
    initialize : function(domObj, position) {
        ...
        this.tabBar = new Jx.Toolbar({type: 'TabBar', position: position});
        ...
        this.panel.addTo(domObj);
        this.tabSet = new Jx.TabSet(this.panel.content);
        this.panel.addEvent('sizeChange', this.tabSet.resizeTabBox.bind(this.tabSet));
...
});// $Id: toolbar.js 853 2008-09-08 17:59:52Z pspencer $
/**
 * Class: Jx.Toolbar
...
Jx.Toolbar = new Class({
    ...
    initialize : function(options) {
        ...
        if (this.options.parent) {
            ...
            if (owner.lastChild && owner.lastChild.hasClass('jxClearer')) {
...
});// $Id: treefolder.js 803 2008-09-02 18:02:13Z pspencer $
/**
 * Class: Jx.TreeFolder
