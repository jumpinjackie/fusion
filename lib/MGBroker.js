...
var MGGetVisibleMapExtent = Class.create();
Object.extend(MGGetVisibleMapExtent.prototype, MGRequest.prototype);
/**
 * @extends MGRequest
 *
 * encapsulate a request to the server to enumerate the data associated with
 ...
 *      MGDescribeSchema should be used for those sources.
 */
Object.extend(  MGGetVisibleMapExtent.prototype, {
    /**
     * @constructor
     * initialize a new instance of MGGetVisibleMapExtent
     *
     * @param sessionId {String} the id of the session to restore
     * @param mapName {String} the id of the session to restore
     * @param viewCenterX {String} the id of the session to restore
     * @param viewCenterY {String} the id of the session to restore
     * @param viewScale {String} the id of the session to restore
     * @param dataExtent {String} the id of the session to restore
     * @param displayDpi {String} the id of the session to restore
     * @param displayWidth {String} the id of the session to restore
     * @param displayHeight {String} the id of the session to restore
     * @param showLayers {String} the id of the session to restore
     * @param hideLayers {String} the id of the session to restore
     * @param showGroups {String} the id of the session to restore
     * @param hideGroups {String} the id of the session to restore
     * @param refreshLayers {String} the id of the session to restore
     *
     * @return {Object} an instance of MGGetVisibleMapExtent
     */
...
var MGQueryMapFeatures = Class.create();
Object.extend(MGQueryMapFeatures.prototype, MGRequest.prototype);
/**
 * @extends MGRequest
 *
 ...
 * selectable layers
 */
Object.extend(  MGQueryMapFeatures.prototype, {
    /**
     * @constructor
     * initialize a new instance of MGQueryMapFeatures
     *
     * @param sessionId {String} the id of the session to restore
     * @param mapName {String} the id of the session to restore
     ...
     *
     * @return {Object} an instance of MGQueryMapFeatures
     */
    initialize : function( sessionId, mapName, geometry, maxFeatures, persist, selectionVariant ) 
    {
        this.initializeRequest();
        this.setParams( {
