...
OpenLayers.Layer.MapGuide = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    */
    ...
    setMap: function(map) {
      ...
      if (this.options.singleTile && !this.isBaseLayer) {
        //this.updateExtents();
        //this.map.events.registerPriority("moveend", this, this.updateExtents);
      }
    },
    
    removeMap: function() {
      if (this.options.singleTile && !this.isBaseLayer) {
        this.map.events.unregister("moveend", this, this.updateExtents);
      }
    },
