 ...
 */
OpenLayers.VERSION_NUMBER="$Revision: 4572 $";
/* ======================================================================
    OpenLayers/Util.js
   ====================================================================== */
...
OpenLayers.Projection = OpenLayers.Class({
     ...
     * sourceProj - {Proj4js.Proj} source map coordinate system
     * destProj - {Proj4js.Proj} destination map coordinate system
     *
     * Returns:
     * point - {object} trasnformed coordinate
     */
  OpenLayers.Projection.transform = function(point, source, dest) {
      return Proj4js.transform(source.proj, dest.proj, point);
  };
/* ======================================================================
    OpenLayers/Ajax.js
   ====================================================================== */
    ...
    setBaseLayer: function(newBaseLayer, noEvent) {
        ...
        if (newBaseLayer != this.baseLayer) {
            ...
            if (OpenLayers.Util.indexOf(this.layers, newBaseLayer) != -1) {
                ...
                //instantiate a Projection for the map
                this.proj = new OpenLayers.Projection(this.baseLayer.projection);
    ...
    initialize: function(name, url, params, options) {
        ...
        if (arguments.length > 0) {
          if (this.options.singleTile) {
            if (params.session && params.mapname) {
              this.params.session = params.session;
              this.params.mapname = params.mapname;
            } else {
              this.params.mapdefinition = params.mapdefinition;
              this.params.locale = 'en';    //TODO: set this programatically
            }
...
*/
          ...
          if (this.options.showLayers) newParams.showlayers = this.options.showLayers;
          if (this.options.hideLayers) newParams.hidelayers = this.options.hideLayers;
          if (this.options.showGroups) newParams.showgroups = this.options.showGroups;
          if (this.options.hideGroups) newParams.hidegroups = this.options.hideGroups;
          if (this.options.refreshLayers) newParams.refreshlayers = this.options.refreshLayers;
